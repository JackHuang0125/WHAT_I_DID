...
\linespread{1.2}
  \begin{itemize}
    \item 以 PCA+KMeans 將樣本分群，得到 $c\in\{0,1\}$；在各群內分別訓練 black-box $\hat f_c$
...
\begin{frame}{\textbf{Results II}　{f\_logistic\& g\_decision}}
\begin{center}
  \begin{minipage}{0.33\linewidth}
    \centering
...
\begin{frame}{\textbf{Results II}　{f\_logistic\& g\_xgb}}
\begin{center}
  \begin{minipage}{0.33\linewidth}
    \centering
...
\begin{frame}{\textbf{Results III}　{Other ML for $\hat{\hat{g}}$}}
