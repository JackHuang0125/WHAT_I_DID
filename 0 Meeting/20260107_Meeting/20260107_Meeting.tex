...
% DISCUSSION 
\section{12/17 Discussion}

\begin{frame}{\textbf{12/17 Discussion}}
\linespread{1.5}
...
\linespread{1.2}
  \begin{itemize}
    \item 以（標準化後、經 SMOTE 平衡的）資料 PCA+KMeans 將樣本分群，得到 $c\in\{0,1\}$；在各群內分別訓練 black-box $\hat f_c$
    \item 給定屬於群 $c$ 的設計點 $x_0$
    ...
    \item 以 $\{(x_{\ell},y_{\ell})\}$ fit local surrogate $\hat g(\cdot;x_0)$，
          使得在 $x_0$ 附近內 $\hat f_c(x)\approx \hat g(x;x_0)$
  \end{itemize}
\end{frame}
...
\begin{center}
  \begin{minipage}{0.33\linewidth}
    \centering
    \includegraphics[width=\linewidth]{c=0_f_logistic&g_linear.png} 
    \tiny{cluster = 0}
  \end{minipage}
  \begin{minipage}{0.33\linewidth}
    \centering
    \includegraphics[width=\linewidth]{c=1_f_logistic&g_linear.png}
    \tiny{cluster = 1}
  \end{minipage}
  \begin{minipage}{0.33\linewidth}
    \centering
    \includegraphics[width=\linewidth]{c=0&1_f_logistic&g_linear.png}
    \tiny{cluster = 0 \& 1}
  \end{minipage}
\end{center}
\end{frame}

\begin{frame}{\textbf{Results III}　{f\_logistic\& g\_decision}}
\begin{center}
  \begin{minipage}{0.33\linewidth}
    \centering
    \includegraphics[width=\linewidth]{c=0_f_logistic&g_decision.png} 
    \tiny{cluster = 0}
  \end{minipage}
  \begin{minipage}{0.33\linewidth}
    \centering
    \includegraphics[width=\linewidth]{c=1_f_logistic&g_decision.png}
    \tiny{cluster = 1}
  \end{minipage}
  \begin{minipage}{0.33\linewidth}
    \centering
    \includegraphics[width=\linewidth]{c=0&1_f_logistic&g_decision.png}
    \tiny{cluster = 0 \& 1}
  \end{minipage}
\end{center}
\end{frame}

\begin{frame}{\textbf{Results IV}　{f\_logistic\& g\_xgb}}
\begin{center}
  \begin{minipage}{0.33\linewidth}
    \centering
    \includegraphics[width=\linewidth]{c=0_f_logistic&g_xgb.png} 
    \tiny{cluster = 0}
  \end{minipage}
  \begin{minipage}{0.33\linewidth}
    \centering
    \includegraphics[width=\linewidth]{c=1_f_logistic&g_xgb.png}
    \tiny{cluster = 1}
  \end{minipage}
  \begin{minipage}{0.33\linewidth}
    \centering
    \includegraphics[width=\linewidth]{c=0&1_f_logistic&g_xgb.png}
    \tiny{cluster = 0 \& 1}
  \end{minipage}
\end{center}
\end{frame}

\begin{frame}{\textbf{Results V}　{f\_xgb\& g\_tree}}
\begin{center}
  \begin{minipage}{0.33\linewidth}
    \centering
    \includegraphics[width=\linewidth]{c=1_f_xgb&g_tree.png} 
    \tiny{cluster = 0}
  \end{minipage}
  \begin{minipage}{0.33\linewidth}
    \centering
  ...
  \begin{minipage}{0.33\linewidth}
    \centering
    \includegraphics[width=\linewidth]{c=0&1_f_xgb&g_tree.png}
    \tiny{cluster = 0 \& 1}
  \end{minipage}
    \begin{minipage}{0.5\linewidth}
    \centering
    \includegraphics[width=\linewidth]{c=0&1_f_xgb&g_tree_tree.png}
  \end{minipage}
\end{center}
\end{frame}

\begin{frame}{\textbf{Results VI}　{Other ML for $\hat{\hat{g}}$}}
...
\begin{center}
  ...
  \begin{minipage}{0.33\linewidth}
    \centering
    \includegraphics[width=\linewidth]{f_logistic&g_decision.png}
    $\hat{f}$ is logistic\\
    $\hat{\hat{g}}$ is decision
  \end{minipage}
