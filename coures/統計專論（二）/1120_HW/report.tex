...
\begin{itemize}
\item 固定其他兩個變數下，以電視和廣播的預算增加仍能提升銷售量，報紙則幾乎沒有影響
\end{itemize}
...
\begin{itemize}
  ...
  \begin{enumerate}[]
    ...
    \item 研究變數：$X_1$：age
    \item 目標變數：$Y_i=1$ if 存活至少五年，$Y_i=0$ if 存活不到五年
  \end{enumerate}
\end{itemize}
...
\hline
ID & time & status & sex & age & year & thickness & ulcer & Surv5yr\\
\hline
1 & 10 & 3 & 1 & 76 & 1972 & 6.76 & 1 & 0 \\
2 & 30 & 3 & 1 & 56 & 1968 & 0.65 & 0 & 0 \\
