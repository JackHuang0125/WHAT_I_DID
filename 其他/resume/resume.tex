...
% \institute{\large{應徵職位：瀚宇博德股份有限公司|\,【資訊】AI 開發工程師}}
% \institute{\large{應徵職位：神達電腦股份有限公司|\,【Server】品保工程師}}
% \institute{\large{應徵職位：矽格股份有限公司 |\,品保工程師}}
% \institute{\large{應徵職位：可成科技股份有限公司|\,品質保證(QA)工程師}} %二面
% \institute{\large{應徵職位：信邦電子股份有限公司|\,品管工程師}}
\institute{\large{應徵職位：瀚宇博德股份有限公司|\,【資訊】AI 開發工程師}} %二面
...
\begin{frame}{\textbf{經驗與成果}}
  ...
  %     \item SPC 基礎、3$\sigma$、RS/P、Shewhart、EWMA、CUSUM、CPD
  %     \item 統計方法連結實務問題
  %   \end{itemize}
  % \end{block}
...
\begin{frame}{\textbf{論文研究　揭密黑箱模型－以半導體製程資料為例}}
  \begin{description}
    ...
    \vspace{1em}
    \item[方法：] 以線性統計方法解釋 XGBoost 預測機率的變化
    \vspace{1em}
    \item[結果：] 1. 決定係數 70\% 量化解釋力　2. 篩選相對重要的特徵
    \vspace{1em}
    \item[價值：] 提供實務決策參考
  \end{description}
\end{frame}
