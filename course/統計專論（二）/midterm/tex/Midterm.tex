...
\begin{itemize}[]
  ...
  \item 研究流程：
    \begin{figure}
      \hspace{-1cm}
      \includegraphics[scale=0.8]{../figures/流程.png}
    \end{figure}
...
{\small
  \hfill $p < 0.001$, \quad 95\% CI = [−4.73, −2.25]}

    \begin{figure}
      \hspace{-10pt}
      \includegraphics[scale=0.63]{../figures/boxplot.png}
    \end{figure}
...
{\Large
  \setlength{\baselineskip}{20pt}
  \parbox{\linewidth}{\raggedright 年長且合併症中重度者的住院天數明顯更久}}
  \medskip \\
  統計結果顯示年齡與合併症交互作用顯著
    \begin{figure}
      \hspace{-0.5cm}
      \includegraphics[scale=0.6]{../figures/result2.png}
    \end{figure}
\end{frame}
...
\begin{itemize}
  ...
  \item 下一步
    \begin{enumerate}
    \item 建立健保給付制度（2026年3月 XX部門）
    \item 積極推廣，再評估（2026年6月 XX部門）
  \end{enumerate}
\end{itemize}
\end{frame}
