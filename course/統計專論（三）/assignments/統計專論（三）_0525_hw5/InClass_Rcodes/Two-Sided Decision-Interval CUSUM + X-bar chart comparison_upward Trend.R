...
# Two-Sided Decision-Interval CUSUM + X-bar chart comparison
...
# Choose shift direction: "up" or "down"
shift_direction <- "up"
...
write.csv(
  result_table,
  "outputs/example42_two_sided_cusum.csv",
  row.names = FALSE
)
...
# 5. summary txt
# -----------------------------
sink("outputs/example42_two_sided_cusum_summary.txt")
...
# -----------------------------
ggsave(
  "figs/ch4_example42_two_sided_xbar_vs_DI_cusum.png",
  p_compare,
  width = 8.6,
  height = 7.4,
  dpi = 300
...
ggsave(
  "figs/ch4_example42_two_sided_DI_cusum.png",
  p_cusum,
  width = 8.2,
  height = 4.9,
  dpi = 300
...
ggsave(
  "figs/ch4_example42_two_sided_xbar_chart.png",
  p_xbar,
  width = 8.2,
  height = 4.8,
  dpi = 300
...
cat(
  ...
  "figs/ch4_example42_two_sided_xbar_chart.png\n",
  "outputs/example42_two_sided_cusum.csv\n",
  "outputs/example42_two_sided_cusum_summary.txt\n"
)